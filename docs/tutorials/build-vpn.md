...
![RackNerd KVM 选择](../images/posts/2026/06/2026-06-28-racknerd-kvm-selection.png)
...
![RackNerd 配置](../images/posts/2026/06/2026-06-28-racknerd-config.png)
...
![Hysteria2 服务器配置](../images/posts/2026/06/2026-06-28-hysteria2-server-config.png)
并将端口改为 443
...
1. 将**Port**栏改为`443`。
   ![v2rayN 端口配置](../images/posts/2026/06/2026-06-28-v2rayn-port-config.png)
2. 同步优化带宽（关键）：为了尝试进一步降低延迟，在`Max bandwidth`处尝试更保守的设置：
   ![v2rayN 带宽配置](../images/posts/2026/06/2026-06-28-v2rayn-bandwidth-config.png)
